...
{  return [[0x42,0x45,0x47,0x49,0x4B][zone],0x00] };

/* use function parameter `zone` with value '0' to target ALL zones, 
 * value '1' for zone 1, value '2' for zone 2,... to 4 */
ColorRgbwCmd.prototype.off = function(zone)
{  return [[0x41,0x46,0x48,0x4A,0x4C][zone],0x00] };
...
{  return [[0xC2,0xC5,0xC7,0xC9,0xCB][zone],0x00] };
...
ColorRgbwCmd.prototype.effectModeNext =	function(){  return [0x4D,0x00] };
ColorRgbwCmd.prototype.effectSpeedUp = 	function(){  return [0x44,0x00] };
ColorRgbwCmd.prototype.effectSpeedDown= function(){  return [0x43,0x00] };

/* Switch zone to Night Light Mode with value '0' to target ALL zones,
 * , value '1' for zone 1, value '2' for zone 2,... to 4 */
ColorRgbwCmd.prototype.nightMode = function(zone)
{ return [[0xC1,0xC6,0xC8,0xCA,0xCC][zone],0x00]; };
...
WhiteCmd.prototype.on = function(zone){  return [[0x35,0x38,0x3D,0x37,0x32][zone],0x00]; };

/* Switch OFF zone with value '0' to target ALL zones, 
 * , value '1' for zone 1, value '2' for zone 2,... to 4 */
WhiteCmd.prototype.off = function(zone)
{ return [[0x39,0x3B,0x33,0x3A,0x36][zone],0x00]; };

/* Switch zone to Night Light Mode with value '0' to target ALL zones, 
 * , value '1' for zone 1, value '2' for zone 2,... to 4 */
WhiteCmd.prototype.nightMode = function(zone)
{ return [[0xB9,0xBB,0xB3,0xBA,0xB6][zone],0x00]; };

/* Switch zone to maximum brightness with value '0' to target ALL zones, 
 * , value '1' for zone 1, value '2' for zone 2,... to 4 */
WhiteCmd.prototype.maxBright = function(zone)
{ return [[0xB5,0xB8,0xBD,0xB7,0xB2][zone],0x00]; };

WhiteCmd.prototype.allOn = 		function(){ return this.on(0) };
WhiteCmd.prototype.allOff = 		function(){ return this.off(0) };
WhiteCmd.prototype.brightUp = 		function(){ return [0x3C,0x00] };
WhiteCmd.prototype.brightDown = 	function(){ return [0x34,0x00] };
WhiteCmd.prototype.warmer = 		function(){ return [0x3E,0x00] };
WhiteCmd.prototype.cooler = 		function(){ return [0x3F,0x00] };


/* RGB BULBS & CONTROLLERS, PREVIOUS GENERATION SINGLE CHANNEL/ZONE*/

ColorRgbCmd.prototype.off = function(){ return [0x21,0x00] };
ColorRgbCmd.prototype.on = function(){ return [0x22,0x00] };
